...
HD_PWD='/home/raxt/CESE_Workspace/CLP_workspace/Guia/Ej18/Sintesis/CountBCD_Lento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log countBCDLento.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source countBCDLento.tcl
