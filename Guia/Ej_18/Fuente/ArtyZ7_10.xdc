...
set_property -dict { PACKAGE_PIN M19  IOSTANDARD LVCMOS33 } [get_ports { ena_i }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { cuenta_o[0] }]; #IO_L6N_T0_VREF_34 Sch=LED0
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { cuenta_o[1] }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { cuenta_o[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { cuenta_o[3] }]; #IO_L23P_T3_35 Sch=LED3
